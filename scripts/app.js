$(document).ready(() => {
  ...
  $('input[type=tel]').inputmask('phoneru')

  $('#toggle').click(() => {
    $('#menu').hasClass('computer')
    && ($('#menu').removeClass('computer') && $('.ui.inverted.green.menu').addClass('stackable'))
    || ($('#menu').addClass('computer') && $('.ui.inverted.green.menu').removeClass('stackable'))
  })
